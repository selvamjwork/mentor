...
@section('content')
@section('navbar')<a href="/ickonadmin/home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a><i class="icon-chevron-right"></i><a href="/ickonadmin/addproduct">All Products</a><i class="icon-chevron-right"></i><a class="current" href="/ickonadmin/addproduct/create">Create Product</a>@endsection
@section('topcontent')Create Product @endsection
<div class="row-fluid">
  <div class="span8">
    <div class="widget-box">
        {!! Form::model($add, ['method' => 'PATCH','url' => ['/ickonadmin/addproduct', $add->id],'class' => 'form-horizontal','files' => true]) !!}
